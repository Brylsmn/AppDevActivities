<html>
   ...
   <body>
		...
		<div class="panel-group" id="myaccordion">
			<div class="panel panel-success">
				...
				<div class="collapse panel-collapse" id="collap1">
					<div class="panel-body">You can put anything in here</div>
				</div>
			</div>
			<div class="panel panel-danger">
				...
				<div class="collapse panel-collapse" id="collap2">
					<div class="panel-body"><img src="img2.jfif"></div>
				</div>	
			</div>
	...
	<div class="container">
		...
		<button class="btn btn-info" data-target="#dtx" data-toggle="collapse">Click to Collapse Pic</button>
		<div id="dty" class="collapse">The data to be collapsed is in here...</div>
		<div id="dtx" class="collapse in"><img src="img1.jfif"></div>
